...
const translations = {
  FR: {
    ...
    skills: { 
      ...
      categories: [
        { title: "Frontend", desc: "Interfaces utilisateur réactives et performantes", skills: ["HTML5", "CSS3", "JavaScript", "JSON", "React", "Tailwind", "Vite"] },
        { title: "Backend", desc: "APIs robustes et architectures scalables", skills: ["Node.js", "PHP", "Python", "Django", "Flask", "Java", "C/C++"] },
        { title: "Base de données", desc: "Gestion et optimisation des données", skills: ["MySQL", "PostgreSQL", "SQL", "Apache"] },
        { title: "Sécurité", desc: "Tests d'intrusion et hardening", skills: ["Pentest", "Zorin Linux", "Metasploit", "Nmap", "Wireshark"] },
        { title: "DevOps & Tools", desc: "CI/CD, conteneurisation et collaboration", skills: ["Docker", "GitHub", "Linux", "AWS", "VS Code", "Postman", "Windows", "Markdown"] }
      ]
    },
    projects: { 
...
certs: {
  ...
  EN: {
    ...
    skills: { 
      ...
      categories: [
        { title: "Frontend", desc: "Responsive and high-performance user interfaces", skills: ["HTML5", "CSS3", "JavaScript", "JSON", "React", "Tailwind", "Vite"] },
        { title: "Backend", desc: "Robust APIs and scalable architectures", skills: ["Node.js", "PHP", "Python", "Django", "Flask", "Java", "C/C++"] },
        { title: "Database", desc: "Data management and optimization", skills: ["MySQL", "PostgreSQL", "SQL", "Apache"] },
        { title: "Security", desc: "Penetration testing and hardening", skills: ["Pentest", "Zorin Linux", "Metasploit", "Nmap", "Wireshark"] },
        { title: "DevOps & Tools", desc: "CI/CD, containerization and collaboration", skills: ["Docker", "GitHub", "Linux", "AWS", "VS Code", "Postman", "Windows", "Markdown"] }
      ]
    },
    projects: { 
      title: "Selected_Works", 
        ...
        <SectionContainer id="skills" title={t.skills.title} subtitle={t.skills.subtitle}>
          <div className="flex md:grid md:grid-cols-2 lg:grid-cols-3 gap-6 overflow-x-auto md:overflow-x-visible snap-x snap-mandatory scrollbar-hide pb-4">
            {t.skills.categories.map((cat, i) => (
              <div key={i} className="min-w-[85vw] md:min-w-0 snap-center bg-white/[0.02] backdrop-blur-md p-6 rounded-3xl border border-white/5 hover:border-cyan-500/30 transition-all group relative overflow-hidden flex flex-col justify-between h-full text-left">
                <div>
                  <div className="flex items-start gap-4 mb-4 relative z-10">
                    <div className="p-3 bg-white/5 rounded-2xl border border-white/10 group-hover:border-cyan-500/40 group-hover:bg-cyan-500/10 transition-all shrink-0">
                    ...
                    <div className="min-w-0">
                      ...
                      {cat.desc && <p className="text-[11px] text-gray-500 font-medium mt-1">{cat.desc}</p>}
                    </div>
                  </div>
